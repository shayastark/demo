        ...
        <div className="max-w-7xl mx-auto flex justify-between items-center gap-2">
          ...
          <div className="flex items-center min-w-0 rounded-full bg-gray-900/70 border border-gray-800 px-2 py-1">
            <button
              ...
              className="btn-unstyled text-sm text-neon-green underline underline-offset-4 decoration-neon-green/80 hover:opacity-80 transition whitespace-nowrap flex-shrink-0 px-1.5"
            >
              FAQ
            </button>
            ...
            <Link
              href="/account"
              className="text-sm text-gray-300 hover:text-white transition truncate max-w-[84px] sm:max-w-[220px] px-1.5"
            >
            ...
            <button
              onClick={logout}
              className="btn-unstyled text-sm text-gray-500 hover:text-gray-300 transition whitespace-nowrap flex-shrink-0 px-1.5"
            >
              Sign out
            </button>
          </div>
