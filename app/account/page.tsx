              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                ...
                <div className="flex items-center" style={{ gap: '12px' }}>
                  <div style={{ width: '24px', minWidth: '24px' }} className="flex items-center justify-center">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" aria-hidden="true">
                      <path
                        d="M21.582 7.186a2.75 2.75 0 0 0-1.935-1.947C17.942 4.75 12 4.75 12 4.75s-5.942 0-7.647.489A2.75 2.75 0 0 0 2.418 7.186C1.93 8.9 1.93 12.5 1.93 12.5s0 3.6.488 5.314a2.75 2.75 0 0 0 1.935 1.947c1.705.489 7.647.489 7.647.489s5.942 0 7.647-.489a2.75 2.75 0 0 0 1.935-1.947c.488-1.714.488-5.314.488-5.314s0-3.6-.488-5.314Z"
                        fill="#FF0033"
                      />
                      <path d="m10.25 15.696 4.95-3.196-4.95-3.196v6.392Z" fill="#fff" />
                    </svg>
                  </div>
                  {isEditingProfile ? (
                    <input
                ...
                <div className="flex items-center" style={{ gap: '12px' }}>
                  <div style={{ width: '24px', minWidth: '24px' }} className="flex items-center justify-center">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" aria-hidden="true">
                      <path
                        d="M14.05 3c.17 1.422.78 2.586 1.834 3.492 1.054.897 2.26 1.355 3.616 1.373v3.154a8.26 8.26 0 0 1-2.367-.349 7.14 7.14 0 0 1-1.983-.998v6.392c0 1.07-.266 2.057-.798 2.962a6.095 6.095 0 0 1-2.15 2.15 5.87 5.87 0 0 1-2.962.798 5.98 5.98 0 0 1-2.99-.798A5.998 5.998 0 0 1 4.05 19.03a5.844 5.844 0 0 1-.807-2.962c0-1.054.266-2.032.798-2.935a6.017 6.017 0 0 1 2.16-2.17 5.87 5.87 0 0 1 2.962-.798c.35 0 .672.03.968.092v3.237a2.85 2.85 0 0 0-.95-.165c-.796 0-1.47.275-2.022.825-.55.55-.825 1.224-.825 2.022 0 .815.275 1.498.825 2.05.551.55 1.225.825 2.023.825.796 0 1.47-.275 2.022-.825.55-.551.825-1.234.825-2.05V3h3.05Z"
                        fill="#fff"
                      />
                      <path
                        d="M14.05 3c.17 1.422.78 2.586 1.834 3.492 1.054.897 2.26 1.355 3.616 1.373v2.17a6.12 6.12 0 0 1-3.666-1.273v6.392c0 1.07-.266 2.057-.798 2.962a6.095 6.095 0 0 1-2.15 2.15 5.87 5.87 0 0 1-2.962.798 5.98 5.98 0 0 1-2.399-.495 5.896 5.896 0 0 0 1.715.257c.796 0 1.47-.275 2.022-.825.55-.551.825-1.234.825-2.05V3h1.963Z"
                        fill="#25F4EE"
                        fillOpacity=".9"
                      />
                      <path
                        d="M14.05 3c.17 1.422.78 2.586 1.834 3.492 1.054.897 2.26 1.355 3.616 1.373v1.036a6.596 6.596 0 0 1-4.22-1.52v6.773c0 1.07-.266 2.057-.798 2.962a6.095 6.095 0 0 1-2.15 2.15 5.87 5.87 0 0 1-2.962.798 5.94 5.94 0 0 1-3.401-1.072 5.92 5.92 0 0 0 1.556.211c.796 0 1.47-.275 2.022-.825.55-.551.825-1.234.825-2.05V3h3.678Z"
                        fill="#FE2C55"
                        fillOpacity=".85"
                      />
                    </svg>
                ...
                <div className="flex items-center" style={{ gap: '12px' }}>
                  <div style={{ width: '24px', minWidth: '24px' }} className="flex items-center justify-center">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" aria-hidden="true">
                      ...
                      <path
                        d="M16.894 15.229a.84.84 0 0 1-1.156.278 9.531 9.531 0 0 0-4.867-1.303 9.77 9.77 0 0 0-2.45.312.84.84 0 0 1-.423-1.625 11.45 11.45 0 0 1 7.33 1.513.84.84 0 0 1 .566.825Zm1.65-2.754a1.05 1.05 0 0 1-1.443.348 11.756 11.756 0 0 0-5.964-1.512 12.04 12.04 0 0 0-2.973.37 1.05 1.05 0 0 1-.513-2.036 14.14 14.14 0 0 1 10.495 1.71 1.05 1.05 0 0 1 .398 1.12Zm.142-2.876a1.261 1.261 0 0 1-1.73.428 14.74 14.74 0 0 0-7.45-1.9 15.1 15.1 0 0 0-3.718.453A1.261 1.261 0 0 1 5.16 6.135a17.646 17.646 0 0 1 4.347-.535c3.1 0 6.06.756 8.634 2.182a1.261 1.261 0 0 1 .545 1.817Z"
                        fill="#0A0A0A"
                      />
                    </svg>
                  </div>
                ...
                <div className="flex items-center" style={{ gap: '12px' }}>
                  <div style={{ width: '24px', minWidth: '24px' }} className="flex items-center justify-center">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" aria-hidden="true">
                      <path
                        d="M19.303 5.337A17.33 17.33 0 0 0 15.05 4a12.29 12.29 0 0 0-.535 1.097 16.138 16.138 0 0 0-4.999 0A12.28 12.28 0 0 0 8.98 4a17.24 17.24 0 0 0-4.255 1.338C2.037 9.314 1.31 13.2 1.672 17.032A17.55 17.55 0 0 0 6.89 19.72a12.62 12.62 0 0 0 1.12-1.82 11.19 11.19 0 0 1-1.765-.85c.148-.109.293-.223.434-.341 3.404 1.597 7.099 1.597 10.462 0 .142.118.287.232.434.341a11.13 11.13 0 0 1-1.767.851c.321.64.696 1.249 1.121 1.82a17.48 17.48 0 0 0 5.218-2.688c.424-4.442-.725-8.292-3.284-11.695ZM9.109 14.67c-1.02 0-1.855-.94-1.855-2.094 0-1.154.818-2.095 1.855-2.095 1.045 0 1.872.95 1.855 2.095 0 1.154-.819 2.094-1.855 2.094Zm5.782 0c-1.02 0-1.855-.94-1.855-2.094 0-1.154.818-2.095 1.855-2.095 1.045 0 1.872.95 1.855 2.095 0 1.154-.81 2.094-1.855 2.094Z"
                        fill="#5865F2"
                      />
                    </svg>
                  </div>
